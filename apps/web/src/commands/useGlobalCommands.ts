    ...
    () => [
      {
        ...
        category: "Navigation",
        description: "Open the Today dashboard",
      ...
      },
      {
        ...
        category: "Navigation",
        description: "Open the document workspace",
        keywords: ["docs", "editor", "writing"],
        priority: 95,
      ...
      },
      {
        ...
        title: "Go to Mail",
        category: "Navigation",
        description: "Open the mail workspace",
      ...
      },
      {
        ...
        category: "Create",
        description: "Open Tasks with a new task ready",
        keywords: ["add task", "todo"],
        shortcut: ["Ctrl", "N"],
        priority: 90,
        run: () => navigate("/tasks?create=1"),
      },
      {
        id: "create-document",
        ...
        priority: 90,
        run: () => navigate("/documents?create=1"),
      },
      {
        id: "create-calendar-event",
        title: "Create calendar event",
        category: "Calendar",
        description: "Open Calendar in creation mode",
        keywords: ["new event", "schedule"],
        run: () => navigate("/calendar?create=1"),
      },
      {
        id: "compose-email",
        title: "Compose email",
        category: "Mail",
        description: "Open Mail in compose mode",
        keywords: ["new mail", "message"],
        run: () => navigate("/mail?compose=1"),
      },
      {
        id: "open-global-search",
        title: "Open Global Search",
        category: "Workspace",
        description: "Search tasks and documents",
        keywords: ["find", "content"],
        shortcut: ["Ctrl", "K"],
        priority: 85,
      ...
      },
      {
        ...
        title: rightSidebarOpen
          ...
          : "Open right sidebar",
        category: "Workspace",
        description: "Toggle the workspace side panel",
      ...
      },
      {
        ...
        category: "Workspace",
        description: "Reload the current workspace view",
